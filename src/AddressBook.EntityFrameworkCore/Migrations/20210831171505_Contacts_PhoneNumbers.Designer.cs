...
namespace AddressBook.Migrations
{
    ...
    [Migration("20210831171505_Contacts_PhoneNumbers")]
    partial class Contacts_PhoneNumbers
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AddressBook.Authorization.Roles.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("AddressBook.Authorization.Users.User", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("AddressBook.Contacts.PhoneNumber", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("AddressBook.MultiTenancy.Tenant", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("AddressBook.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("AddressBook.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("AddressBook.Authorization.Roles.Role", b =>
                {
                    b.HasOne("AddressBook.Authorization.Users.User", "CreatorUser")
                        .WithMany()
                        .HasForeignKey("CreatorUserId");

                    b.HasOne("AddressBook.Authorization.Users.User", "DeleterUser")
                        .WithMany()
                        .HasForeignKey("DeleterUserId");

                    b.HasOne("AddressBook.Authorization.Users.User", "LastModifierUser")
                        .WithMany()
            ...
            modelBuilder.Entity("AddressBook.Contacts.Contact", b =>
                {
                    b.OwnsOne("AddressBook.Contacts.Address", "Address", b1 =>
                        {
            ...
            modelBuilder.Entity("AddressBook.Contacts.PhoneNumber", b =>
                {
                    b.HasOne("AddressBook.Contacts.Contact", "Contact")
