...
{
    public abstract class AddressBookWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static AddressBookWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(AddressBookWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<AddressBookDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<AddressBookDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<AddressBookDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<AddressBookDbContext, Task<T>> func)
        {
            T result;
